    ...
    <div >
        <div class="row">
            <div class="col-sm-12">
                ...
                <span class="page--clarification" v-else>Dit zijn jouw antwoorden. Met een account kun je jouw antwoorden vergelijken met de group of andere individuele scans. Kies in het volgende scherm de belangrijkste verbeterpunten.</span>
            </div>
        </div>
